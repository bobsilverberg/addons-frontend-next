...
export default function IconXMark({ className, ...iconProps }) {
  return (
    <Icon
      {...iconProps}
      className={makeClassName(styles.IconXMark, className)}
      name="inline-content"
    >
      <svg
        className={styles['IconXMark-svg']}
        version="1.1"
        xmlns="http://www.w3.org/2000/svg"
        xmlnsXlink="http://www.w3.org/1999/xlink"
      >
        <g
          className={styles['IconXMark-path']}
